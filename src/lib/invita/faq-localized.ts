...
export const FAQ_AR: Record<string, { q: string; a: string }> = {
  "What is IV therapy?": {
    ...
    a: "العلاج الوريدي يُسلّم الفيتامينات والمعادن والأحماض الأمينية مباشرة في الدم. بذلك تتجاوز الجهاز الهضمي ويكون الامتصاص شبه كامل — على عكس المكملات الفموية.",
  },
