              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color:           tab === t ? "#0F2341" : "#6B7A94",
                    padding:         "0.75rem 1.25rem",
                    background:      "none",
                    border:          "none",
                    borderBottom:    tab === t ? "2px solid #D9B344" : "2px solid transparent",
                    cursor:          "pointer",
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      fontSize:        "0.6875rem",
                      fontWeight:      500,
                      backgroundColor: tab === t ? "rgba(217,179,68,0.15)" : "rgba(107,122,148,0.1)",
                      color:           tab === t ? "#D9B344" : "#6B7A94",
                      borderRadius:    "9999px",
